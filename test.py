...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: Sajal Sharma", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr : 211B264", font='Arial 16 bold', fg='blue').pack()
                                            ...
                                            if len(name)>0 and len(name)<20:
                                                if age>0 and age<150:
                                                    if seats>0 and seats<=45:
                                                        ...
                                                        showerror("booking limit exceed","Not Available")
                                                else:
    ...
    def check_booking_page(self):
        ...
        def check_tkt():
            ...
            if len(mobile)==10 and mobile.isdigit():
                ...
                Label(text="YOUR TICKET", font='Arial 12 bold', bg='red',fg='white').grid(row=6,columnspan=12 )
                Label(text="Booking ref = "+b_ref,font='Arial 12 bold', fg='green').grid(row=7,column=4)
                Label(text="Name = " + name, font='Arial 12 bold', fg='green').grid(row=7, column=5)
                Label(text="Gender = " + gen, font='Arial 12 bold', fg='green').grid(row=7, column=6)
                Label(text="Total seats = " + str(seat), font='Arial 12 bold', fg='green').grid(row=7, column=7)
                Label(text="Age = " + str(age), font='Arial 12 bold', fg='green').grid(row=7, column=8)
                Label(text="Booked on = " + book_date, font='Arial 12 bold', fg='green').grid(row=8, column=4)
                Label(text="Travel date = " + travel_date, font='Arial 12 bold', fg='green').grid(row=8, column=5)
                Label(text="Fare = " + str(fare), font='Arial 12 bold', fg='green').grid(row=8, column=6)
                Label(text="Amount to be paid = " + str(fare*seat), font='Arial 12 bold', fg='green').grid(row=10, column=6)
